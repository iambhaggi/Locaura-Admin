...
class StoreModel with _$StoreModel {
  const factory StoreModel({
    ...
    @JsonKey(name: 'retailer_name') required String retailerName,
    @JsonKey(name: 'retailer_phone') required String retailerPhone,
    @JsonKey(name: 'retailer_email') required String retailerEmail,
